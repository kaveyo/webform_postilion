...
namespace webform_postilion
{
    ...
    public partial class Instant_Add_New_Customer : System.Web.UI.Page
    {
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            if (customer_d.Text == "" || mobile.Text == "" || datepicker34.Text == "" || address_1_1.Text == "")
            {
            ...
            else
            {
                    ...
                    using (SqlConnection sqlCon = new SqlConnection(obj.locate1))
                    {
                        ...
                        sqlCon.Open();
                        string query = " insert into postilion_portal_changes (maker,date,change_made,pan,account,branch,reason,checker,view_status) values ('" + str3.Text + "','" + time.ToString(format) + "','ADD NEW CUSTOMER INSTANT','"+pan+"','','" + str.Text + "','REQUEST TO ADD NEW CUSTOMER','" + str2.Text + "' , '0')";
