<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Instant_Replace2.aspx.cs" Inherits="webform_postilion.Instant_Replace2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div class="form-horizontal">
        <h4>INSTANT REPLACE 3</h4>
        <hr />
<div class="container">
