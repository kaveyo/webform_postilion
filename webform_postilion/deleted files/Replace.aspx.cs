...
namespace webform_postilion
{
    public partial class Replace : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Replace1.aspx?pan=" + TextBox1.Text + "&card_sep=" + TextBox2.Text + "&reason=" + RadioButtonList1.Text + "&hold_response=" + DropDownList2.Text + "&mail=" + RadioButtonList2.Text);
        }
