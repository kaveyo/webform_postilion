<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Instant_Replace1.aspx.cs" Inherits="webform_postilion.Instant_Replace1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div class="form-horizontal">
        <h4>INSTANT REPLACE 2</h4>
        <hr />
<div class="container">
