<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add_Existing_Customer.aspx.cs" Inherits="webform_postilion.Add_Existing_Customer" %>
      ...
      <div class="row">
         <div class="form-group col-md-5">
            ...
            <div class="col-md-7">
                     ...
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="RequiredField" ForeColor="Red" ControlToValidate="datepicker34" Enabled="False"></asp:RequiredFieldValidator> </div>
